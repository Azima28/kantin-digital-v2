...
/// Broadcast section used inside [AdminSettingsScreen].
///
/// Displays audience dropdown, message textarea, and send button.
class AdminSettingsBroadcastSection extends StatelessWidget {
  ...
  const AdminSettingsBroadcastSection({
    super.key,
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: const [
                DropdownMenuItem(
                    value: 'all', child: Text('Semua Pengguna')),
                DropdownMenuItem(
                    value: 'merchants', child: Text('Khusus Pedagang')),
                DropdownMenuItem(
                    value: 'students', child: Text('Khusus Siswa')),
                DropdownMenuItem(
                    value: 'staff', child: Text('Khusus Staf')),
              ],
              onChanged: (val) {
                if (val != null) {
