                  ...
                  children: [
                    Expanded(
                      child: Row(
                        ...
                        children: const [
                          SkeletonBox(width: 20, height: 30, borderRadius: 4),
                          SkeletonBox(width: 20, height: 50, borderRadius: 4),
                          SkeletonBox(width: 20, height: 40, borderRadius: 4),
                          SkeletonBox(width: 20, height: 65, borderRadius: 4),
                          SkeletonBox(width: 20, height: 45, borderRadius: 4),
                          SkeletonBox(width: 20, height: 75, borderRadius: 4),
                          SkeletonBox(width: 20, height: 55, borderRadius: 4),
                        ],
                      ),
                    ),
                    const SizedBox(height: 6),
                    Row(
                      ...
                      children: List.generate(
                        7,
                        (i) => const SkeletonBox(width: 20, height: 6, borderRadius: 2),
                      ),
                    ),
                  ],
                ),
