...
class ParentAmountSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: [
        _buildQuickAmountItem(context, 10000, 'Rp 10.000'),
        _buildQuickAmountItem(context, 20000, 'Rp 20.000'),
        _buildQuickAmountItem(context, 50000, 'Rp 50.000'),
        _buildQuickAmountItem(context, 100000, 'Rp 100.000'),
        _buildQuickAmountItem(context, 200000, 'Rp 200.000'),
        _buildQuickAmountItem(context, 500000, 'Rp 500.000'),
      ],
    );
  }

  Widget _buildQuickAmountItem(BuildContext context, int amount, String label) {
