                  ...
                  child: transactionsAsync.when(
                    data: (List<Map<String, dynamic>> txs) {
                      ...
                      final filteredTxs = txs.where((tx) {
                        ...
                        // Filter match
                        if (_selectedFilterIndex == 1 && type != 'purchase')
                          return false;
                        if (_selectedFilterIndex == 2 && type != 'topup')
                          return false;

                        // Search query match
                        if (_searchQuery.isNotEmpty) {
                          if (type == 'topup') {
                            return 'top-up saldo'.contains(_searchQuery) ||
                                'koperasi'.contains(_searchQuery);
                          }
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, sectionIndex) {
                          final sectionTitle = groupedTxs.keys.elementAt(
                            sectionIndex,
                          );
