...
class TopupQrisCheckoutSheet extends ConsumerStatefulWidget {
  final double amount;
  ...
  @override
  ConsumerState<TopupQrisCheckoutSheet> createState() => _TopupQrisCheckoutSheetState();
}

class _TopupQrisCheckoutSheetState extends ConsumerState<TopupQrisCheckoutSheet> {
  ...
  void _handleConfirm() async {
    ...
    await widget.onConfirmPayment(widget.amount);
  }
