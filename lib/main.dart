...
void main() async {
  ...
  // Bungkus runApp dalam runZonedGuarded biar error global tertangkap.
  // NOTE: Ada warning "Zone mismatch" karena WidgetsFlutterBinding
  // diinit di root zone, tapi runApp di guarded zone.
  // Warning ini NON-FATAL secara default — aman diabaikan.
  runZonedGuarded(() {
    runApp(
      const ProviderScope(
        child: MainApp(),
